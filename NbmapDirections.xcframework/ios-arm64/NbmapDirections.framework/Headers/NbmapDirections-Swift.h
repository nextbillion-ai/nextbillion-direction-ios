...
#ifndef NBMAPDIRECTIONS_SWIFT_H
#define NBMAPDIRECTIONS_SWIFT_H
...
#import <NbmapDirections/NbmapDirections.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NbmapDirections",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
